...
class PlayerCRM(roomai.abstract.AbstractPlayer):
    ...
    def __init__(self, num_players = 2):
        ...
        self.handcards_conv1 = tf.nn.conv2d(self.handcards_variables, self.handcards_w["conv_w1"],[1,1,1,1],padding="VALID")
        self.handcards_pool1 = tf.nn.max_pool(self.handcards_conv1,[1,2,2,1],[1,1,1,1],padding="VALID")
        self.handcards_conv2 = tf.nn.conv2d(self.handcards_pool1, self.handcards_w["conv_w2"],[1,1,1,1],padding="VALID")
        ...
        self.opponent_handcards_w["conv_w2"] = tf.Variable(tf.float32,[5 * self.num_players, 2, 2, 10 * self.num_players])

        self.opponent_handcards_conv1        = tf.nn.conv2d(self.opponent_handcards_variables, self.opponent_handcards_w["conv_w1"],\
                                                            [1,1,1,1], padding="VALID")
        self.opponent_handcards_pool1        = tf.nn.max_pool(self.opponent_handcards_conv1,[1,2,2,1],[1,1,1,1],padding="VALID")
        self.opponent_handcards_conv2        = tf.nn.conv2d(self.opponent_handcards_conv1,     self.opponent_handcards_w["conv_w2"],\
                                                            [1,1,1,1], padding="VALID")
        self.opponent_handcards_pool2        = tf.nn.max_pool(self.opponent_handcards_conv2,[1,2,2,1],[1,1,1,1],padding="VALID")
        ...
        self.total_vector = tf.concat(1,[self.chips_vector, self.bets_vector, self.handcards_vector, self.opponent_handcards_vector])
